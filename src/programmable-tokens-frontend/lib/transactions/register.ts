import {
  ...
  import { cip113_scripts_subStandard } from "../substandards/deploy";
  import {
  ...
  const buildRegistrationTransaction = async (
    assetName: string,
    quantity: string,
    ...
    const payee = recipientAddress && recipientAddress.trim() !== ""
      ? recipientAddress
      : changeAddress;
    ...
    const unsignedTx = await txBuilder
      ...
      .txOut(payee, programmableTokenAssets)
  ...
  export { buildRegistrationTransaction };
